# Custom Claw Server (ARCHIVED)

> **Archived: 2026-02-22.** This is a complete copy of the custom Express server that was deployed at `openclaw.doughy.app`. Replaced by the official OpenClaw multi-agent platform. See `docs/OPENCLAW_PLATFORM.md`.
>
> **Rollback:** Can be redeployed in <30 min. See `docs/DEPLOYMENT.md` for droplet access.

---

# OpenClaw Gateway (Original README)
