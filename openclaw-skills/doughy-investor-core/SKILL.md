...
Core AI assistant capabilities for Real Estate Investors. Handles seller outreach, agent relationship management, deal tracking, and follow-up sequences. This skill transforms OpenClaw from a rental-focused assistant to a comprehensive RE investor communication tool.
