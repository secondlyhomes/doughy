...
## Purpose
Connect OpenClaw to Doughy's Supabase database. This skill provides the foundation
for all other Doughy skills to query and update data via the openclaw-bridge Edge Function.
...
### Edge Functions
- `/openclaw-bridge` - Main API endpoint for all CRUD operations
