...
DROP POLICY IF EXISTS "landlord_properties_workspace_select" ON public.landlord_properties;
DROP POLICY IF EXISTS "landlord_properties_workspace_insert" ON public.landlord_properties;
DROP POLICY IF EXISTS "landlord_properties_workspace_update" ON public.landlord_properties;
DROP POLICY IF EXISTS "landlord_properties_workspace_delete" ON public.landlord_properties;
...
DROP POLICY IF EXISTS "landlord_rooms_workspace_select" ON public.landlord_rooms;
DROP POLICY IF EXISTS "landlord_rooms_workspace_insert" ON public.landlord_rooms;
DROP POLICY IF EXISTS "landlord_rooms_workspace_update" ON public.landlord_rooms;
DROP POLICY IF EXISTS "landlord_rooms_workspace_delete" ON public.landlord_rooms;
...
DROP POLICY IF EXISTS "landlord_bookings_workspace_select" ON public.landlord_bookings;
DROP POLICY IF EXISTS "landlord_bookings_workspace_insert" ON public.landlord_bookings;
DROP POLICY IF EXISTS "landlord_bookings_workspace_update" ON public.landlord_bookings;
DROP POLICY IF EXISTS "landlord_bookings_workspace_delete" ON public.landlord_bookings;
...
DROP POLICY IF EXISTS "landlord_conversations_workspace_select" ON public.landlord_conversations;
DROP POLICY IF EXISTS "landlord_conversations_workspace_insert" ON public.landlord_conversations;
DROP POLICY IF EXISTS "landlord_conversations_workspace_update" ON public.landlord_conversations;
DROP POLICY IF EXISTS "landlord_conversations_workspace_delete" ON public.landlord_conversations;
...
DROP POLICY IF EXISTS "landlord_messages_workspace_select" ON public.landlord_messages;
DROP POLICY IF EXISTS "landlord_messages_workspace_insert" ON public.landlord_messages;
DROP POLICY IF EXISTS "landlord_messages_workspace_update" ON public.landlord_messages;
DROP POLICY IF EXISTS "landlord_messages_workspace_delete" ON public.landlord_messages;
...
DROP POLICY IF EXISTS "landlord_ai_queue_items_workspace_select" ON public.landlord_ai_queue_items;
DROP POLICY IF EXISTS "landlord_ai_queue_items_workspace_insert" ON public.landlord_ai_queue_items;
DROP POLICY IF EXISTS "landlord_ai_queue_items_workspace_update" ON public.landlord_ai_queue_items;
DROP POLICY IF EXISTS "landlord_ai_queue_items_workspace_delete" ON public.landlord_ai_queue_items;
...
DROP POLICY IF EXISTS "landlord_inventory_items_workspace_select" ON public.landlord_inventory_items;
DROP POLICY IF EXISTS "landlord_inventory_items_workspace_insert" ON public.landlord_inventory_items;
DROP POLICY IF EXISTS "landlord_inventory_items_workspace_update" ON public.landlord_inventory_items;
DROP POLICY IF EXISTS "landlord_inventory_items_workspace_delete" ON public.landlord_inventory_items;
...
DROP POLICY IF EXISTS "landlord_maintenance_records_workspace_select" ON public.landlord_maintenance_records;
DROP POLICY IF EXISTS "landlord_maintenance_records_workspace_insert" ON public.landlord_maintenance_records;
DROP POLICY IF EXISTS "landlord_maintenance_records_workspace_update" ON public.landlord_maintenance_records;
DROP POLICY IF EXISTS "landlord_maintenance_records_workspace_delete" ON public.landlord_maintenance_records;
...
DROP POLICY IF EXISTS "landlord_vendors_workspace_select" ON public.landlord_vendors;
DROP POLICY IF EXISTS "landlord_vendors_workspace_insert" ON public.landlord_vendors;
DROP POLICY IF EXISTS "landlord_vendors_workspace_update" ON public.landlord_vendors;
DROP POLICY IF EXISTS "landlord_vendors_workspace_delete" ON public.landlord_vendors;
...
DROP POLICY IF EXISTS "landlord_vendor_messages_workspace_select" ON public.landlord_vendor_messages;
DROP POLICY IF EXISTS "landlord_vendor_messages_workspace_insert" ON public.landlord_vendor_messages;
DROP POLICY IF EXISTS "landlord_vendor_messages_workspace_update" ON public.landlord_vendor_messages;
DROP POLICY IF EXISTS "landlord_vendor_messages_workspace_delete" ON public.landlord_vendor_messages;
...
DROP POLICY IF EXISTS "landlord_turnovers_workspace_select" ON public.landlord_turnovers;
DROP POLICY IF EXISTS "landlord_turnovers_workspace_insert" ON public.landlord_turnovers;
DROP POLICY IF EXISTS "landlord_turnovers_workspace_update" ON public.landlord_turnovers;
DROP POLICY IF EXISTS "landlord_turnovers_workspace_delete" ON public.landlord_turnovers;
...
DROP POLICY IF EXISTS "landlord_booking_charges_workspace_select" ON public.landlord_booking_charges;
DROP POLICY IF EXISTS "landlord_booking_charges_workspace_insert" ON public.landlord_booking_charges;
DROP POLICY IF EXISTS "landlord_booking_charges_workspace_update" ON public.landlord_booking_charges;
DROP POLICY IF EXISTS "landlord_booking_charges_workspace_delete" ON public.landlord_booking_charges;
...
DROP POLICY IF EXISTS "landlord_deposit_settlements_workspace_select" ON public.landlord_deposit_settlements;
DROP POLICY IF EXISTS "landlord_deposit_settlements_workspace_insert" ON public.landlord_deposit_settlements;
DROP POLICY IF EXISTS "landlord_deposit_settlements_workspace_update" ON public.landlord_deposit_settlements;
DROP POLICY IF EXISTS "landlord_deposit_settlements_workspace_delete" ON public.landlord_deposit_settlements;
...
DROP POLICY IF EXISTS "landlord_guest_templates_workspace_select" ON public.landlord_guest_templates;
DROP POLICY IF EXISTS "landlord_guest_templates_workspace_insert" ON public.landlord_guest_templates;
DROP POLICY IF EXISTS "landlord_guest_templates_workspace_update" ON public.landlord_guest_templates;
DROP POLICY IF EXISTS "landlord_guest_templates_workspace_delete" ON public.landlord_guest_templates;
...
DROP POLICY IF EXISTS "landlord_turnover_templates_workspace_select" ON public.landlord_turnover_templates;
DROP POLICY IF EXISTS "landlord_turnover_templates_workspace_insert" ON public.landlord_turnover_templates;
DROP POLICY IF EXISTS "landlord_turnover_templates_workspace_update" ON public.landlord_turnover_templates;
DROP POLICY IF EXISTS "landlord_turnover_templates_workspace_delete" ON public.landlord_turnover_templates;
...
DROP POLICY IF EXISTS "investor_deals_pipeline_workspace_select" ON public.investor_deals_pipeline;
DROP POLICY IF EXISTS "investor_deals_pipeline_workspace_insert" ON public.investor_deals_pipeline;
DROP POLICY IF EXISTS "investor_deals_pipeline_workspace_update" ON public.investor_deals_pipeline;
DROP POLICY IF EXISTS "investor_deals_pipeline_workspace_delete" ON public.investor_deals_pipeline;
...
DROP POLICY IF EXISTS "investor_deal_events_workspace_select" ON public.investor_deal_events;
DROP POLICY IF EXISTS "investor_deal_events_workspace_insert" ON public.investor_deal_events;
DROP POLICY IF EXISTS "investor_deal_events_workspace_update" ON public.investor_deal_events;
DROP POLICY IF EXISTS "investor_deal_events_workspace_delete" ON public.investor_deal_events;
...
DROP POLICY IF EXISTS "investor_campaigns_workspace_select" ON public.investor_campaigns;
DROP POLICY IF EXISTS "investor_campaigns_workspace_insert" ON public.investor_campaigns;
DROP POLICY IF EXISTS "investor_campaigns_workspace_update" ON public.investor_campaigns;
DROP POLICY IF EXISTS "investor_campaigns_workspace_delete" ON public.investor_campaigns;
...
DROP POLICY IF EXISTS "investor_drip_campaign_steps_workspace_select" ON public.investor_drip_campaign_steps;
DROP POLICY IF EXISTS "investor_drip_campaign_steps_workspace_insert" ON public.investor_drip_campaign_steps;
DROP POLICY IF EXISTS "investor_drip_campaign_steps_workspace_update" ON public.investor_drip_campaign_steps;
DROP POLICY IF EXISTS "investor_drip_campaign_steps_workspace_delete" ON public.investor_drip_campaign_steps;
...
DROP POLICY IF EXISTS "investor_drip_enrollments_workspace_select" ON public.investor_drip_enrollments;
DROP POLICY IF EXISTS "investor_drip_enrollments_workspace_insert" ON public.investor_drip_enrollments;
DROP POLICY IF EXISTS "investor_drip_enrollments_workspace_update" ON public.investor_drip_enrollments;
DROP POLICY IF EXISTS "investor_drip_enrollments_workspace_delete" ON public.investor_drip_enrollments;
...
DROP POLICY IF EXISTS "investor_agents_workspace_select" ON public.investor_agents;
DROP POLICY IF EXISTS "investor_agents_workspace_insert" ON public.investor_agents;
DROP POLICY IF EXISTS "investor_agents_workspace_update" ON public.investor_agents;
DROP POLICY IF EXISTS "investor_agents_workspace_delete" ON public.investor_agents;
...
DROP POLICY IF EXISTS "investor_follow_ups_workspace_select" ON public.investor_follow_ups;
DROP POLICY IF EXISTS "investor_follow_ups_workspace_insert" ON public.investor_follow_ups;
DROP POLICY IF EXISTS "investor_follow_ups_workspace_update" ON public.investor_follow_ups;
DROP POLICY IF EXISTS "investor_follow_ups_workspace_delete" ON public.investor_follow_ups;
...
DROP POLICY IF EXISTS "investor_outreach_templates_workspace_select" ON public.investor_outreach_templates;
DROP POLICY IF EXISTS "investor_outreach_templates_workspace_insert" ON public.investor_outreach_templates;
DROP POLICY IF EXISTS "investor_outreach_templates_workspace_update" ON public.investor_outreach_templates;
DROP POLICY IF EXISTS "investor_outreach_templates_workspace_delete" ON public.investor_outreach_templates;
...
DROP POLICY IF EXISTS "investor_conversations_workspace_select" ON public.investor_conversations;
DROP POLICY IF EXISTS "investor_conversations_workspace_insert" ON public.investor_conversations;
DROP POLICY IF EXISTS "investor_conversations_workspace_update" ON public.investor_conversations;
DROP POLICY IF EXISTS "investor_conversations_workspace_delete" ON public.investor_conversations;
...
DROP POLICY IF EXISTS "investor_messages_workspace_select" ON public.investor_messages;
DROP POLICY IF EXISTS "investor_messages_workspace_insert" ON public.investor_messages;
DROP POLICY IF EXISTS "investor_messages_workspace_update" ON public.investor_messages;
DROP POLICY IF EXISTS "investor_messages_workspace_delete" ON public.investor_messages;
...
DROP POLICY IF EXISTS "crm_contacts_workspace_select" ON public.crm_contacts;
DROP POLICY IF EXISTS "crm_contacts_workspace_insert" ON public.crm_contacts;
DROP POLICY IF EXISTS "crm_contacts_workspace_update" ON public.crm_contacts;
DROP POLICY IF EXISTS "crm_contacts_workspace_delete" ON public.crm_contacts;
...
DROP POLICY IF EXISTS "comms_call_logs_workspace_select" ON public.comms_call_logs;
DROP POLICY IF EXISTS "comms_call_logs_workspace_insert" ON public.comms_call_logs;
DROP POLICY IF EXISTS "comms_call_logs_workspace_update" ON public.comms_call_logs;
DROP POLICY IF EXISTS "comms_call_logs_workspace_delete" ON public.comms_call_logs;
...
DROP POLICY IF EXISTS "comms_call_transcripts_workspace_select" ON public.comms_call_transcripts;
DROP POLICY IF EXISTS "comms_call_transcripts_workspace_insert" ON public.comms_call_transcripts;
DROP POLICY IF EXISTS "comms_call_transcripts_workspace_update" ON public.comms_call_transcripts;
DROP POLICY IF EXISTS "comms_call_transcripts_workspace_delete" ON public.comms_call_transcripts;
