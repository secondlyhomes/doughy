// MoltBot webhook handler for processing incoming rental platform emails
...
/**
 * Main webhook handler - processes incoming emails through the MoltBot pipeline
 *
 * Steps:
 * 1. Parse email to extract platform and contact info
 * 2. Create/update contact via moltbot-bridge
...
export async function handleIncomingEmail(
  ...
  try {
    ...
    // Step 2: Create or update contact via moltbot-bridge
