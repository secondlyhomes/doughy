// src/features/leads/components/UploadLeadDocumentSheet.tsx
// Bottom sheet for uploading documents to a lead/seller
...
interface UploadLeadDocumentSheetProps {
  leadId: string;
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
...
export function UploadLeadDocumentSheet({
  leadId,
  isOpen,
  onClose,
  onSuccess,
}: UploadLeadDocumentSheetProps) {
  const colors = useThemeColors();
  const { pickDocument, uploadDocument, isLoading, error, uploadProgress } = useLeadDocumentMutations();
  ...
  const handleUpload = useCallback(async () => {
    ...
    setValidationError(null);
    const result = await uploadDocument(leadId, selectedFile, {
      title: title.trim(),
      category,
  ...
  }, [selectedFile, title, category, description, leadId, uploadDocument, onSuccess, onClose]);
  ...
  return (
    <BottomSheet visible={isOpen} onClose={handleClose} title="Upload Seller Document">
