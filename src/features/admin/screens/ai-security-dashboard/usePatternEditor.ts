// src/features/admin/screens/ai-security-dashboard/usePatternEditor.ts
// State management and Supabase operations for the pattern editor
...
export type EditorMode = 'list' | 'add' | 'edit';
...
export interface PatternTestState {
  testInput: string;
  testResult: { matches: boolean; error?: string } | null;
}
...
export function usePatternEditor({ visible, onPatternsChanged }: UsePatternEditorOptions) {
